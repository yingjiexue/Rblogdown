...
> (4) @lettau2020factors 扩展主成分分析(PCA)来解释无套利。他们表明，无套利惩罚项可以克服金融数据中的低信噪比问题，并找到与定价核相关的信息。
...
L(w\|\hat{g},I_t,I\_{ti})=\frac{1}{N}\sum*{i=1}^{N}^*\frac{T_i}{T}\|\frac{1}{T_i}\sum*{t*\in T_i}{M{t+1}R\_{t+1,i}{e}\hat{g}(I_t,I{ti})}\|\^2
