...
>  1、Boehmer等（2008）研究牛禹证券交易所定价难数据发现，市场中各类股票都存在卖空交易，卖空交易者获利是利用信息优势。

>  2、Chan和Hameed(2006)研究新型市场发现，分析师跟进的作用更多的是挖掘市场和行业层面的信息，进而导致股价同步性的增加。

> 3、才静涵和夏乐（2011）研究发现，香港市场引入卖空机制后，市场交易活跃度下降，知情交易概率（PIN）和信息不对称程度升高，是源于噪声交易者参与程度降低。
