...
$$E[P]=\int _{\frac{(1-c)a_F}{2}}^{\frac{(1+c)a_F}{2}}Pf(S)dS+\int _{-\frac{(1-c)a_F}{2}}^{\frac{(1-c)a_F}{2}}Pf(S)dS+\int _{-\frac{(1+c)a_F}{2}}^{-\frac{(1-c)a_F}{2}}Pf(S)dS\\
=\frac{1}{(1+c)a_F}\bigg[S^2-\bar\theta\sigma_u^2S-(1-w)[\frac{3\sigma_u^2}{2w}ln(1+\frac{w}{12\sigma_u^2}[(1+c)a_F-2S])+\frac{\bar\theta\sigma_u^2}{w}S\\+(\frac{\bar\theta\sigma_u^2}{2w}-\frac{(1+c)a_F}{4})(\frac{w}{12\sigma_u^2})^{-\frac{1}{2}}arctan(\sqrt{\frac{w}{12\sigma_u^2}}[(1+c)a_F-2S])\bigg]\bigg|_{\frac{(1-c)a_F}{2}}^{\frac{(1+c)a_F}{2}}\\
+\frac{1}{(1+c)a_F}\bigg[S^2-\bar\theta\sigma_u^2S-(1-w)[\frac{S^2}{2(1+\frac{wc^2a_F^2}{3\sigma_u^2})}+\frac{S\frac{c^2a_F^2\bar\theta}{3}}{(1+\frac{wc^2a_F^2}{3\sigma_u^2})}\bigg]\bigg|_{-\frac{(1-c)a_F}{2}}^{\frac{(1-c)a_F}{2}}\\
+\frac{1}{(1+c)a_F}\bigg[S^2-\bar\theta\sigma_u^2S-(1-w)[\frac{3\sigma_u^2}{2w}ln(1+\frac{w}{12\sigma_u^2}[(1+c)a_F+2S])+\frac{\bar\theta\sigma_u^2}{w}S\\-(\frac{\bar\theta\sigma_u^2}{2w}+\frac{(1+c)a_F}{4})(\frac{w}{12\sigma_u^2})^{-\frac{1}{2}}arctan(\sqrt{\frac{w}{12\sigma_u^2}}[(1+c)a_F+2S])\bigg]\bigg|_{-\frac{(1+c)a_F}{2}}^{-\frac{(1-c)a_F}{2}}\\
=\frac{1}{(1+c)a_F}\bigg[-\bar\theta\sigma_u^2(1+c)a_F-(1-w)\frac{(1-c)c^2a_F^3}{1+wc^2a_F^2/3\sigma_u^2}-\frac{\theta\sigma_u^2}{w}\sqrt{12\sigma_u^2/w}arctan(\sqrt{\frac{w}{12\sigma_u^2}}2ca_F)\bigg]$$
...
c=seq(0,1,0.01)
w=0.5
P=(-theta*simamu*(1+c)*af-(1-w)*(1-c)*c^2*af^3/(1+w*c^2*af^2/(3*simamu))-theta*simamu/w*sqrt(12*simamu/w)*atan(sqrt(w/(12*simamu))*2*c*af))/((1+c)*af)
