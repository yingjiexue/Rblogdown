...
res<-persp(c,w, matrix(Empo$EPdif,21,21), theta = 30, shade = 0.75,col =rainbow(441),ltheta=30,ticktype="detailed",xlab = "c",zlab = "E[P]-E[P*]")
...
res<-persp(c,w, matrix(Empo$EVdif,21,21), theta = -50, shade = 0.75,col =rainbow(441),ltheta=30,phi = 30,ticktype="detailed",xlab = "c",zlab = "Var[P]-Var[P*]")
