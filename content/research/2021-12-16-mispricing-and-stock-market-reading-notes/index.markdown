...
> ETF为识别和研究非基本面需求提供了独一无二的环境，虽然基本价值本质上是不可观察的，但 ETF 及其基础资产具有相同的基本价值，因此，两者之间的一价定律的违反意味着着ETF和基础资产至少一个受到非基本面需求的影响。这时专业的套利者通过申购或赎回ETF来纠正这种价格偏离。本文通过理论和实证证明了ETF资金流可以识别基本面错误定价，投资者可以从误定价修正中获得超额收益。
...
> 1.共同基金申购和赎回反应了投资者对管理能力的信念变化，也反应了投资者争先恐后地从管理技能中获得超额收益 Berk and Green ([2004](#ref-berk2004mutual)) 。

> 2.  Evans et al. ([2017](#ref-evans2017etf)) 描述了权威投资者如何等到T+6期才申购ETF，避免了与卖空相关的成本。

> 3.  Hayley ([2014](#ref-hayley2014hindsight)) 证明了内部收益率（IRRs）可能由于业绩好的基金流出增加，业绩差的基金流入增加而被推高。

### 实证结果

> **1.非基本面需求冲击与ETF收益反转**

> 通过理论模型已经证明ETF资金流和ETF溢价变化意味着ETF和基础资产错误定价是一个相对非基本面需求冲击，ETF资金流和折溢价改变为识别基本面错误定价提供了信息。在这部分，我们通过组合分析法来探讨ETF资金流和溢价变化与未来横截面收益的关系。

> ![](images/tzzh.jpeg)

> 上图报告了基于ETF资金流和溢价变化构造的多空组合累计收益，我们发现，基于ETF资金流构造的投资组合累计收益随着组合持有期上升而上升，但基于ETF溢价变化构造的投资组合累计收益无明显变化趋势，表明只有ETF资金流很好地捕捉了非基本面需求冲击。

> ![](images/zhsy.png)

> 表3统计了不同ETF组合收益，我们发现在组合形成1-6月内，多空投资策略都可以获得显著的超额收益。

> **2.非基本面冲击与ETF净值收益**

> ![](images/zunav.png)

> 表4统计了不同ETF组合净值收益，我们发现在组合形成1-6月内，投资基础资产的多空投资策略都也可以获得显著的超额收益。

### 研究结论

> 本文从理论和实证上证明了ETF 申购赎回资金流反应了一个强烈的非基本面需求冲击的信号，资金流最多的ETF比资金流出最多的ETF未来收益低。我们发现非基本面需求引起ETF投资者系统性地错失投资时机，从而导致他们的利润减少。我们的发现提出了未来研究的几个领域。通过证明非基本面需求冲击在1个月、3个月和6个月的范围内有不同的影响，我们的结果表明，在不同的范围内，非基本面需求可能存在额外的变化，影响资产价格。换句话说，未来的研究应该调查非基本面需求冲击的期限结构和它们逆转的速度。
...
<div id="ref-berk2004mutual">

Berk, Jonathan B, and Richard C Green. 2004. “Mutual Fund Flows and Performance in Rational Markets.” *Journal of Political Economy* 112 (6): 1269–95. <https://www.journals.uchicago.edu/doi/abs/10.1086/424739>.
...
<div id="ref-evans2017etf">

Evans, Richard, Rabih Moussawi, Michael S Pagano, and John Sedunov. 2017. “ETF Failures-to-Deliver: Naked Short-Selling or Operational Shorting?” *Work. Pap., Villanova Univ*.

</div>

<div id="ref-hayley2014hindsight">

Hayley, Simon. 2014. “Hindsight Effects in Dollar-Weighted Returns.” *Journal of Financial and Quantitative Analysis* 49 (1): 249–69. <https://openaccess.city.ac.uk/id/eprint/6226/1/>.
